...
public class test extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        b.setOnAction(e -> {
            ...
            var temp = g.plotPoints(Graph.graphType.Market.set_put(null, 'd', null), new Data().getMarketData(new Date(System.currentTimeMillis()), "market@2024-06-12_00:00:00-23:59:00.csv"), Graph.GraphSize.REGULAR);
